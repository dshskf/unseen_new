...
import { sign_in, sign_up, send_email } from '../../../Redux/auth/auth-action'
                                ...
                                <React.Fragment>
                                    <input type="text" name="username" placeholder="Username" value={this.state.username} onChange={this.inputHandler} />
                                    {
                                        this.state.page === "register" ?
                                            <React.Fragment>
                                                <input type="text" name="email" placeholder="Email" value={this.state.email} onChange={this.inputHandler} />
                                                <input type="text" name="phone" placeholder="Phones" value={this.state.phone} onChange={this.inputHandler} />
                                            </React.Fragment>
                                            :
                                            null
